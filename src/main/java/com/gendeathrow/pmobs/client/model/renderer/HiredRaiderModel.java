...
//    private final boolean smallArms;
	...
	public HiredRaiderModel(float modelSize) 
	{
...
//        }
	...
	public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
	{
		...
		if (mainHand != null && mainHand.getItem() == Items.BOW && ((HiredRaider)entitylivingbaseIn).isSwingingArms())
		{
		...
		if (mainHand != null && ((HiredRaider)entitylivingbaseIn).getRaiderRole() == EnumRaiderRole.BRUTE && ((HiredRaider)entitylivingbaseIn).isSwingingArms())
		{
			if (entitylivingbaseIn.getPrimaryHand() == EnumHandSide.RIGHT)
			{
				this.rightArmPose = ModelBiped.ArmPose.BOW_AND_ARROW;

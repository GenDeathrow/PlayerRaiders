...
public class EntityPyroRenderer extends RenderBiped<EntityPyromaniac> 
{
		private final ModelBiped defaultModel;
		    
		private boolean flag = false;
		    
		public EntityPyroRenderer(RenderManager renderManager)
		{
		...
		@Override
		protected ResourceLocation getEntityTexture(EntityPyromaniac entity) 
		{
			return entity.getLocationSkin();
		}
		
		@Override
		public void doRender(EntityPyromaniac entity, double x, double y, double z, float entityYaw, float partialTicks)
		{
			if(!PMSettings.renderNameTags)
			{

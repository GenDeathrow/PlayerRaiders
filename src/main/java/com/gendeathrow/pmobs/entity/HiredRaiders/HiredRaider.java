...
public class HiredRaider extends HiredBase implements IEntityOwnable
{
	    ...
	    public HiredRaider(World worldIn)
	    {
	        super(worldIn);
	        this.setupTamedAI();
	    }
	    ...
	    public ResourceLocation getLocationSkin()
	    {
			...
			{
				if(RaiderManager.getRaiderProfile(this.getOwnerSkin()) != null)
				{
					this.setPlayerProfile(RaiderManager.getRaiderProfile(this.getOwnerSkin()));
				}
				else
				{
					this.setPlayerProfile(RaiderManager.getRaiderProfile(this.getOwnerSkin()));

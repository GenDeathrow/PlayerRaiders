...
public class RaiderClassConfigs extends JsonConfig{
	...
	public void readFile() {
		...
		JsonObject raiderObject = defaultClassJson("Raider", 80, 0, 0.1, null);
			PMSettings.raiderClass = isEnabled(raiderObject);
			PMSettings.raidersSpawnWeight = getWeight(raiderObject);
			//TODO Drops
			
		JsonObject bruteObject = defaultClassJson("Brute", 7, 0, 0.1, new Object[] {new ItemStack(RegisterItems.bruteSerumSample), 10});
		...
		JsonObject pyromaniacObject = defaultClassJson("Pyromaniac", 4, 0, 0.1, null);
		...
		JsonObject tweakerObject = defaultClassJson("Tweaker", 5, 0, 0.1, null);
			if(!tweakerObject.has("spawnOnlyAtNight")) {
				tweakerObject.addProperty("startDiff", false);
		...
		JsonObject witchObject = defaultClassJson("Witch", 2, 0, 0.1, new Object[] {new ItemStack(Items.DRAGON_BREATH), 1}, new Object[] {new ItemStack(Items.EMERALD), 10}, new Object[] {new ItemStack(Items.SPIDER_EYE), 20}, new Object[] {new ItemStack(Items.EXPERIENCE_BOTTLE, 3), 40}, new Object[] {new ItemStack(Items.MUSHROOM_STEW), 40}); 
		...
		JsonObject archerObject = defaultClassJson("Archer", 10, 1, 0.1, null);
